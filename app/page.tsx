...
export default function Home() {
  return <>
    <main id="about-me" className="h-full container py-8 flex flex-col justify-center self-center flex-grow max-w-screen-lg">
      <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-center">
        ...
        <article className="text-justify flex flex-col gap-4" id="about-me-blurb">
