...
function ProjectCardSkeleton() {
  return (
    <div className="rounded-2xl p-6 pt-8 flex flex-col gap-4">
      {/* image */}
...
export default function Loading() {
  return (
    <SkeletonTheme baseColor="var(--color-surface)" highlightColor='var(--color-surface-raised)'>
      <main className="h-full container py-8 flex flex-col self-center grow gap-8 md:gap-12">
        ...
        <div className="flex gap-4 items-center">
          ...
          <Skeleton height={40} width={80} borderRadius="2rem" />
          <Skeleton height={40} width={80} borderRadius="2rem" />
          <Skeleton height={40} width={80} borderRadius="2rem" />
        </div>
        {/* grid */}
