...
export default function Footer() {
  return <footer className="py-8 px-6 flex justify-center bg-background/90">
    <div className="w-full max-w-screen-2xl flex flex-col items-center justify-between gap-4 sm:flex-row">
      <span>© Harry Nguyen 2026</span>
